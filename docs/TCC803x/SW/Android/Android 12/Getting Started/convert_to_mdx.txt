...
def center_resize_images_outside_tables(content):
    ...
    # Zoom import 자동 삽입
    if '<Zoom>' in content and 'import Zoom' not in content:
        content = "import Zoom from 'react-medium-image-zoom';\n"
        content += "import 'react-medium-image-zoom/dist/styles.css';\n\n" + content

    return content

# Typora-style alert → Admonition 변환
